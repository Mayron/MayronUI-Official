    ...
    return {
        {   name    = "Timer Bars";
            ...
            children = {
                ...
                -- },
                -- {   type = "loop",
                --     args = db.profile.timerBars.field_names:GetTable(),
                ...
                --                         dbPath = "profile.timerBars."..name..".unit",
                --                         options = {
                --                             L["Player"],
                --                             L["Target"],
                --                             L["TargetTarget"],
                ...
                --                     {   name = L["Bar Width"],
                --                         type = "slider",
                --                         dbPath = "profile.timerBars."..name..".bar_width",
                --                         step = 1,
                --                         min = 100,
                --                         max = 400,
                --                     },
                --                     {   name = L["Bar Height"],
                --                         type = "slider",
                --                         dbPath = "profile.timerBars."..name..".bar_height",
                --                         step = 1,
                --                         min = 5,
                --                         max = 50,
                --                     },
                --                     {   name = L["Bar Spacing"],
                --                         type = "slider",
                --                         dbPath = "profile.timerBars."..name..".spacing",
                --                         step = 1,
                --                         min = 0,
                --                         max = 10,
                --                     },
                ...
                --                     {   name = L["Show Icons"],
                --                         type = "check",
                --                         dbPath = "profile.timerBars."..name..".show_icons",
                --                     },
                --                     {   name = L["Show Spark"],
                --                         type = "check",
                --                         dbPath = "profile.timerBars."..name..".spark",
                --                     },
                --                     {   type = "divider"
                --                     },
                --                     {   name = L["Background Color"],
                --                         type = "color",
                --                         dbPath = "profile.timerBars."..name..".colors.background",
                --                     },
                --                     {   name = L["Buff Bar Color"],
                --                         type = "color",
                --                         dbPath = "profile.timerBars."..name..".colors.basicBuff",
                --                     },
                --                     {   name = L["Debuff Bar Color"],
                --                         type = "color",
                --                         dbPath = "profile.timerBars."..name..".colors.basicDebuff",
                --                     },
                --                     {   type = "divider"
                --                     },
                --                     {   type = "fontstring",
                ...
                --                         type = "textfield",
                --                         value_type = "string",
                --                         dbPath = "profile.timerBars."..name..".position.point",
                ...
                --                         type = "textfield",
                --                         value_type = "string",
                --                         dbPath = "profile.timerBars."..name..".position.relativeFrame",
                --                         OnLoad = function(_, container)
                ...
                --                         type = "textfield",
                --                         value_type = "string",
                --                         dbPath = "profile.timerBars."..name..".position.relativePoint",
                ...
                --                     },
                --                     {   name = L["X-Offset"],
                --                         dbPath = "profile.timerBars."..name..".position.x",
                ...
                --                     },
                --                     {   name = L["Y-Offset"],
                --                         dbPath = "profile.timerBars."..name..".position.y",
                ...
                --                         height = 50,
                --                         min_width = true,
                --                         dbPath = "profile.timerBars."..name..".time.show",
                --                     },
                --                     {   name = L["Font Size"],
                --                         type = "slider",
                ...
                --                         min = 8,
                --                         max = 22,
                --                         dbPath = "profile.timerBars."..name..".time.font_size",
                --                     },
                --                     {   name = L["Font Type"],
                --                         type = "dropdown",
                --                         dbPath = "profile.timerBars."..name..".time.font",
                --                         font_chooser = true,
                ...
                --                         height = 50,
                --                         min_width = true,
                --                         dbPath = "profile.timerBars."..name..".spell_name.show",
                --                     },
                --                     {   name = L["Font Size"],
                --                         type = "slider",
                --                         tooltip = L["Default is 11"],
                ...
                --                         min = 8,
                --                         max = 22,
                --                         dbPath = "profile.timerBars."..name..".spell_name.font_size",
                --                     },
                --                     {   name = L["Font Type"],
                --                         type = "dropdown",
                --                         dbPath = "profile.timerBars."..name..".spell_name.font",
                --                         font_chooser = true,
                --                         options = tk.Constants.LSM:List("font"),
                --                     },
                --                 }
