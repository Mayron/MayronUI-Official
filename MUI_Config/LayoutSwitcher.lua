...
function C_LayoutSwitcher:CreateScrollFrameRowContent(data,
                                                      dbObject,
                                                      addOnName)
...
function C_LayoutSwitcher:ShowLayoutTool(data)
  ...
  gui:AddTitleBar(
    tk.Constants.AddOnStyle, data.layoutTool, L["MUI Layout Tool"]);
  gui:AddCloseButton(
    tk.Constants.AddOnStyle, data.layoutTool, nil, tk.Constants.CLICK);
  ...
  for addOnName, dbObject in pairs(supportedAddOns) do
    local checkButton, dropdown = self:CreateScrollFrameRowContent(
                                    dbObject, addOnName);
  ...
  data.menu.layoutsDropDown = gui:CreateDropDown(
  ...
  data.menu.createButton:SetScript(
    "OnClick", function()
      self:CreateLayout()
    end);
  ...
  data.menu.renameButton:SetScript(
    "OnClick", function()
      self:RenameLayout()
    end);
  ...
  data.menu.deleteButton:SetScript(
    "OnClick", function()
      self:DeleteLayout()
    end);
