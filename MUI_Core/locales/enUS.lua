...
--[[
This file can used as a template for other languages.
Just change the localization and booleans in the first line.
Example:
	                                                           V      V      V
	local L = LibStub("AceLocale-3.0"):NewLocale ("MayronUI", "esES", false, true) 
	
	1. Localization code
	2. Default language for AceLocal. Has to be false for ALL but "enUS"
	3. Silence Mode. If true, no errors will be thrown because of missing translations.
...
-- No need for english translation. Since MUI is coded in english.
