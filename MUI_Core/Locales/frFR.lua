...
L["If the SUF Player or Target portrait bars are enabled, a class colored gradient will overlay it."] = "Si les barres de portraits SUF du joueur ou de la cible sont activées, une classe Le dégradé coloré le superposera.";
...
L["Found a bug? Use this form to submit an issue to the official MayronUI GitHub page."] = "Vous avez trouvé un bug? Utilisez ce formulaire pour soumettre un problème à la page officielle MayronUI GitHub.";
...
L["Only 1 active chat frame can show the chat icons on the sidebar (see icons listed below)."] = "Seul 1 cadre de discussion actif peut afficher les icônes de discussion dans la barre latérale (voir les icônes répertoriées ci-dessous).";
L["Horizontal Top Buttons"] = "Boutons supérieurs horizontaux";
L["This option will affect all active chat frames. To configure each individual button per chat frame, see the chat frame sub-menus below."] = "Cette option affectera tous les cadres de discussion actifs. Pour configurer chaque bouton individuel par discussion frame, voir les sous-menus du chat frame ci-dessous.";
L["Chat Channels"] = "Canaux de discussion";
L["Professions"] = "Métiers";
L["AddOn Shortcuts"] = "Raccourcis complémentaires";
L["Copy Chat"] = "Copier le chat";
L["Emotes"] = "Émoticônes";
L["Online Status"] = "État en ligne";
L["None"] = "Aucun";
L["Deafen"] = "Sourd";
L["Mute"] = "Muet";
L["If checked, this module will be enabled."] = "Si coché, ce module sera activé.";
L["Unit Tooltip Options"] = "Options d'info-bulle d'unité";
...
L["If checked, the target of the unit (NPC or player) displayed in the tooltip will be shown."] = "Si cochée, la cible de l'unité (PNJ ou joueur) affichée dans l'info-bulle sera affichée.";
L["If checked and the player is in a guild, the guild rank of the player displayed in the tooltip will be shown."] = "Si coché et que le joueur est dans une guilde, le rang de guilde du joueur affiché dans la une info-bulle s'affichera.";
...
L["Show Item Level"] = "Afficher le niveau de l'article";
L["In Combat Options"] = "Options de combat";
L["Show Unit Tooltips In Combat"] = "Afficher les info-bulles d'unité en combat";
L["Show Guild Rank"] = "Afficher le rang de guilde";
L["Show Target"] = "Afficher la cible";
L["Show Standard Tooltips In Combat"] = "Afficher les infobulles standard en combat";
L["Standard tooltips display non-unit related information, such as action-bar abilities, buffs and debuffs, and more."] = "Les infobulles standard affichent des informations non liées à l'unité, telles que les capacités de la barre d'action, les buffs et les debuffs, et plus.";
L["Unit tooltips display player and NPC information while your mouse cursor is over a unit in the game world."] = "Les infobulles des unités affichent les informations sur les joueurs et les PNJ lorsque le curseur de votre souris est sur une unité dans le monde du jeu.";
L["Appearance Options"] = "Options d'apparence";
L["These options allow you to customize the appearance of the tooltips."] = "Ces options vous permettent de personnaliser l'apparence des infobulles.";
L["Font Flag"] = "Police de caractère Drapeau";
...
L["Reskin using the MUI texture or a custom backdrop"] = "Reskin en utilisant la texture MUI ou un arrière-plan personnalisé";
L["Texture"] = "Texture";
L["Texture Options"] = "Options de texture";
L["Custom Backdrop"] = "Fond personnalisé";
L["The MUI texture controls both the background and border textures. If you want a more customized style, use the 'Custom Backdrop' style instead (see the previous menu)."] = "La texture MUI contrôle à la fois l'arrière-plan et la bordure Si vous souhaitez un style plus personnalisé, utilisez plutôt le style 'Custom Backdrop' (voir le menu précédent).";
L["Use MUI Theme Color"] = "Utiliser la couleur du thème MUI";
L["If checked, the MUI texture will use your MUI theme color for both the background and border color (by default, this is class-colored)."] = "Si coché, la texture MUI utilisera la couleur de votre thème MUI pour la couleur de l'arrière-plan et de la bordure (par défaut, il s'agit de la couleur de la classe).";
L["Custom Color"] = "Couleur personnalisée";
L["If not using the MUI theme color, the tooltip will use this custom color for both the background and border color."] = "Si vous n'utilisez pas la couleur du thème MUI, l'info-bulle utilisera cette couleur personnalisée pour l'arrière-plan et couleur de la bordure.";
...
L["If checked, the backdrop border color will be based on the class of the player unit or the type of NPC unit."] = "Si cochée, la couleur de bordure de fond sera basée sur la classe de l'unité de joueur ou le type d'unité PNJ.";
L["Border Color"] = "Couleur de la bordure";
L["If color border by class or NPC type is checked, this color will be used for all non-unit tooltips, else it will be used for every tooltip border."] = "Si la bordure de couleur par classe ou type de PNJ est cochée , cette couleur sera utilisée pour toutes les infobulles non unitaires, sinon elle sera utilisée pour chaque bordure d'infobulle.";
...
L["Unit Tooltip Anchor Point"] = "Point d'ancrage de l'info-bulle de l'unité";
L["Mouse Cursor"] = "Curseur de la souris";
L["Screen Corner"] = "Coin de l'écran";
...
L["Set the text format of the value that appears on the status bar. Set this to 'None' to hide the text."] = "Définissez le format de texte de la valeur qui apparaît dans la barre d'état. Réglez-le sur ' Aucun' pour masquer le texte.";
L["Current/Maximum"] = "Courant/Maximum";
L["Percentage"] = "Pourcentage";
L["Power Bar"] = "Barre de puissance";
L["If checked, unit tooltips will show the unit's power bar."] = "Si cochée, les infobulles des unités afficheront la barre d'alimentation de l'unité.";
L["Unit Aura Options"] = "Options d'aura d'unité";
L["If checked, unit tooltips will show the unit's buffs."] = "Si cochée, les infobulles des unités afficheront les buffs de l'unité.";
L["Above"] = "Au-dessus";
L["Below"] = "En dessous";
L["Position"] = "Positionner";
L["Set whether you want the unit's buffs to appear above or below the tooltip."] = "Définissez si vous voulez que les buffs de l'unité apparaissent au-dessus ou en dessous de l'infobulle.";
L["Left to Right"] = "De gauche à droite";
L["Right to Left"] = "De droite à gauche";
L["If checked, unit tooltips will show the unit's debuffs."] = "Si cochée, les infobulles des unités afficheront les debuffs de l'unité.";
L["Set border color by debuff type"] = "Définir la couleur de la bordure par type de debuff";
L["If enabled, the border color of debuffs will be based on the type of debuff (e.g., poisons will appear with a green border color)."] = "Si activé, la couleur de bordure des debuffs sera basée sur le type de debuff (par exemple, les poisons apparaîtront avec une couleur de bordure verte).";
L["Set whether you want the unit's debuffs to appear above or below the tooltip."] = "Définissez si vous voulez que les débuffs de l'unité apparaissent au-dessus ou en dessous de l'infobulle.";
L["Buff and Debuff Ordering"] = "Ordre de buff et de debuff";
L["The below setting controls the ordering of auras on the tooltip when both the buffs and debuffs are positioned together (either above or below the tooltip) and are both enabled."] = "Le paramètre ci-dessous contrôle l'ordre des auras sur le info-bulle lorsque les buffs et les debuffs sont positionnés ensemble (au-dessus ou en dessous de l'info-bulle) et sont tous deux activés.";
...
L["Sets the alpha of timer bars for auras not produced by you (i.e., other player or NPC buffs and debuffs)."] = "Définit l'alpha des barres de minuterie pour les auras non produites par vous buffs et debuffs).";
L["Show Professions"] = "Afficher les métiers";
L["Show AddOn Shortcuts"] = "Afficher les raccourcis complémentaires";
...
L["This is the animated character portrait frame that shows when an NPC is talking to you."] = "C'est le cadre de portrait de personnage animé qui s'affiche lorsqu'un PNJ vous parle.";
...
L["Enable Expand and Retract Feature"] = "Activer la fonctionnalité de développement et de retrait";
L["If disabled, you will not be able to toggle between 1 and 2 rows of action bars."] = "Si désactivé, vous ne pourrez pas basculer entre 1 et 2 lignes de barres d'action.";
...
L["If checked, the reputation bar will use a fixed color instead of dynamically changing based on your reputation with the selected faction."] = "Si cochée, la barre de réputation utilisera une couleur fixe au lieu de changer dynamiquement en fonction de votre réputation avec la faction sélectionnée.";
...
Vous pouvez entièrement personnaliser l'interface utilisateur à l'aide du menu de configuration :]]
