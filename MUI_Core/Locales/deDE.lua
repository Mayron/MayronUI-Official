...
L["Bartender4 Action Bars"] = "Bartender Aktionsleisten";
L["Row"] = "Reihe";
...
L["Set MUI Frames Color"] = "Legen Sie die Farbe der MUI-Rahmen fest";
...
L["Show Item Levels"] = "Artikelebenen anzeigen";
