...
L["Are you sure you want to reset the money data for all of your characters?"] = "Are you sure you want to reset the money data for all of your characters?";
L["All money data has been reset."] = "All money data has been reset.";
L["Are you sure you want to reset the money data for %s?"] = "Are you sure you want to reset the money data for %s?";
...
L["If checked, this module will be enabled."] = "If checked, this module will be enabled.";
L["Test mode allows you to easily customize the looks and positioning of widgets by forcing all widgets to be shown."] = "Test mode allows you to easily customize the looks and positioning of widgets by forcing all widgets to be shown.";
...
L["This button opens the most relevant missions menu for your character. The menu will either show missions for your Covenant Sanctum, Class Order Hall, or your Garrison."] = "This button opens the most relevant missions menu for your character. The menu will either show missions for your Covenant Sanctum, Class Order Hall, or your Garrison.";
L["Tracking Icon"] = "Tracking Icon";
L["When hidden, you can still access tracking options from the Minimap right-click menu."] = "When hidden, you can still access tracking options from the Minimap right-click menu.";
...
L["If checked, the food and drink buff will be displayed as a castbar."] = "If checked, the food and drink buff will be displayed as a castbar.";
L["Blend Mode"] = "Blend Mode";
L["Changing the blend mode will affect how alpha channels blend with the background."] = "Changing the blend mode will affect how alpha channels blend with the background.";
...
L["Show Auras With Unknown Time Remaining"] = "Show Auras With Unknown Time Remaining";
...
L["Some settings will not be changed until the UI has been reloaded."] = "Some settings will not be changed until the UI has been reloaded.";
