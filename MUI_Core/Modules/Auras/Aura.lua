...
--   local header = tk:CreateFrame("Frame", parent, nil, "SecureAuraHeaderTemplate");

--   local btn = tk:CreateFrame("Button", header, nil, "SecureActionButtonTemplate, SecureAuraTemplate")
--   btn.header = header;
...
--     btn:SetAttribute("index", auraID);
--     btn:SetAttribute("type", "cancelaura");

--     header:SetAttribute("unit", "player");
--     header:SetAttribute("filter", "HELPFUL");
--     header:SetAttribute("includeWeapons", 1);
--     header:SetAttribute("template", "SecureAuraTemplate");

--     -- if (filter == false) then
--     --   if (auraID == 16) then
--     --     btn:SetAttribute("target-slot", 1); -- Main-Hand
--     --   elseif (auraID == 17) then
--     --     btn:SetAttribute("target-slot", 2); -- Off-Hand
--     --   end
--     -- else
--     --   btn:SetAttribute("index", auraID);
--     -- end
